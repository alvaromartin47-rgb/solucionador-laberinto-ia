...
from entidades.mapa import Coord, Mapa
from laberinto import generar_laberinto
from entidades.ia.ia import IA
...
class ModoIA(tk.Toplevel):
    ...
    def actualizar_vista(self):
        ...
        visitados = self.ia.visitados()
        camino = self.ia.camino()
