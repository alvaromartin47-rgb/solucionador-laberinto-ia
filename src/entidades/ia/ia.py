from entidades.ia.funciones import camino_minimo, cargar_grafo
...
class IA:
    ...
    def __init__(self, mapa):
        ...
        """
        self.mapa = mapa
        self.grafo = cargar_grafo(self.mapa)
        
        (
            self.solucion_pila,
            self.solucion_set
        ) = camino_minimo(self.grafo, self.mapa, self.mapa.final)
        
        self.concurridos = set()
        self.act = mapa.inicio
